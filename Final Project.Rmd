...
```{r, echo=FALSE, fig.height=2.5, fig.width=4, fig.cap="Salary vs Years at Company"}
...
ggplot(data = salary) + 
  ...
  labs(title = "(b) Salary vs Year at the Company", x = "Years at the Company", y = "Total Yearly Compensation")
```
...
```{r, echo=FALSE, fig.height=3, fig.width=4, fig.cap="Salary vs Years at Company"}
# Education
ggplot(data = salary) + 
  aes(x = Education, y = totalyearlycompensation) + 
  geom_jitter(aes(color = title_1), size = .6, alpha = 0.1) + 
  geom_smooth(aes(color = title_1), method = "lm", se = FALSE, formula = 'y ~ x') + 
  labs(title = "(a) Salary vs Education", x = "Education", y = "Total Yearly Compensation")

ggplot(data = salary) + 
  aes(x = Education, y = totalyearlycompensation) + 
  geom_jitter(aes(color = Race), size = .6, alpha = 0.1) + 
  geom_smooth(aes(color = Race), method = "lm", se = FALSE, formula = 'y ~ x') + 
  labs(title = "(b) Salary vs Education", x = "Education", y = "Total Yearly Compensation")
```
...
```{r, echo=FALSE, fig.height=3, fig.width=4, fig.cap="Salary vs Gender"} 
# Gender
ggplot(data = salary) + 
  aes(x = gender, y = totalyearlycompensation) + 
  geom_jitter(aes(color = title_1), size = .6, alpha = 0.1) + 
  geom_smooth(aes(color = title_1), method = "lm", se = FALSE, formula = 'y ~ x') + 
  labs(title = "(a) Salary vs Gender", x = "Gender", y = "Total Yearly Compensation")

ggplot(data = salary) + 
  aes(x = gender, y = totalyearlycompensation) + 
  geom_jitter(aes(color = Race), size = .6, alpha = 0.1) + 
  geom_smooth(aes(color = Race), method = "lm", se = FALSE, formula = 'y ~ x') + 
  labs(title = "(b) Salary vs Gender", x = "Gender", y = "Total Yearly Compensation")
```
...
```{r, echo=FALSE, fig.height=3, fig.width=4, fig.cap="Salary vs Experience Years"}
# Year of experience
ggplot(data = salary) + 
...
```{r echo=FALSE, fig.height=3, fig.width=4, fig.cap="Salary vs Location"}
# Location
ggplot(data = salary) + 
  aes(x = cityid, y = totalyearlycompensation) + 
  geom_jitter(aes(color = title_1), size = .6, alpha = 0.1) + 
  geom_smooth(aes(color = title_1), method = "lm", se = FALSE, formula = 'y ~ x') + 
  labs(title = "(a) Salary vs Location", x = "City in USA", y = "Total Yearly Compensation")

ggplot(data = salary) + 
  aes(x = cityid, y = totalyearlycompensation) + 
  geom_jitter(aes(color = Race), size = .6, alpha = 0.1) + 
  geom_smooth(aes(color = Race), method = "lm", se = FALSE, formula = 'y ~ x') + 
  labs(title = "(b) Salary vs Location", x = "City in USA", y = "Total Yearly Compensation")
```

```{r echo=FALSE, fig.height=3, fig.width=4, fig.cap="Salary vs Time"}
# Time stamp
ggplot(data = salary) + 
...
```{r echo=FALSE, fig.height=3, fig.width=4, fig.cap="Salary vs Stock"}
# Stock Grant Value
ggplot(data = salary) + 
...
```{r echo=FALSE, fig.height=3, fig.width=4, fig.cap="Salary vs Bonus"}
# Bonus
ggplot(data = salary) + 
