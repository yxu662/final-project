...
```{r, echo=FALSE, warning=FALSE, fig.cap="Correlation Graph", fig.width=6, fig.height=6}
corr <- cor(cor[,1:8], use="complete.obs")
GGally::ggcorr(corr, method = c("everything", "pearson"), label = TRUE, label_alpha = TRUE)
```
...
(Intercept)        1.167e+01  2.306e-01  7.922e+00  50.614 3.11e-11 ***
yearsofexperience  3.855e-01  2.221e-02  8.862e+00  17.358 3.80e-08 ***
yearsatcompany    -6.792e-02  1.049e-02  6.848e+00  -6.473 0.000376 ***
cityid            -6.387e-02  2.037e-02  6.408e+00  -3.135 0.018503 *  
education          7.778e-02  1.436e-02  9.135e+00   5.416 0.000403 ***
gender             9.973e-02  1.764e-02  1.691e+04   5.655 1.59e-08 ***
